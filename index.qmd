...
- 2026-09-08 section @sec-oversegmentation introduce v1.1.0 over-fitting solver.
...
{{< video https://youtu.be/uvsoBODrmpw >}}
...
- **Be fast**: practitioners should obtain valuable outputs within minutes of computation. Slow workflows do not scale to real Pzen inventories.
...
{{< video https://youtu.be/_CrEEW4pM08 >}}
...
* [AMAP-Lab](https://amap.cirad.fr/en/unite.php) (Olivier Martin; Nicolas Barbier) Contributed financially through IRD funding and [One Forest Vision](https://www.oneforestvision.org/eng) (OFVi) project towards several improvements in Arbor as well as ongoing R&D on tropical rainforest data
...
![](figures/logo/amap.jpeg){width=200px}

![](figures/logo/onevision.jpeg){width=200px}

![](figures/logo/usherbrooke.jpg){width=200px}

![](figures/logo/nrcan.png){width=200px}

![](figures/logo/ffto.jpg){width=200px}

![](figures/logo/mrnf.png){width=200px}


![](figures/logo/uquat.png){width=200px}
:::
